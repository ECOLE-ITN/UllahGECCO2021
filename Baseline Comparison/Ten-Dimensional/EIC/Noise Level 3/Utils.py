...
def worst_case_prediction(Point , Model, Scaler):
    ...
    bounds = ((-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4))
    n_restarts = 2
    n_params = 10
...
def expected_improvement(candidate, robust_optimum, Model, Scaler, n_params = 10):
...
def sample_next_point(acquisition_func, Model, robust_optimum, Scaler, 
                      bounds = ((-0.6,0.6),(-0.6,0.6),(-0.6,0.6), (-0.6,0.6),
                                (-0.6,0.6),(-0.6,0.6), (-0.6,0.6),(-0.6,0.6),(-0.6,0.6),(-0.6,0.6)) , n_restarts = 25):
