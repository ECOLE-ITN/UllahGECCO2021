...
def branin (X):
    """ 
    Two-Dimensional Branin Test Function
    """
    x1, x2 = X.ravel()
...
def sample_next_point(acquisition_func, Model, robust_optimum, temp, Scaler, bounds = ((-2,7), (3,12)) , n_restarts = 25):
...
def find_robust_optimum_location (Model, Scaler):
