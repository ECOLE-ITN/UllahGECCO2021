...
def eight_dimensional (X):
    """ 
    Eight-Dimensional Test Function. cf. Eq.(18)
    """
    X = np.asarray(X)
...
def worst_case_prediction(Point , Model, Scaler):
    ...
    bounds = ((-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4),(-0.4,0.4))
    n_restarts = 2
    n_params = 8
...
def expected_improvement(candidate, robust_optimum, Model, Scaler, n_params = 8):
...
def sample_next_point(acquisition_func, Model, robust_optimum, Scaler, 
                      bounds = ((-0.6,0.6),(-0.6,0.6),(-0.6,0.6), (-0.6,0.6),
                                (-0.6,0.6),(-0.6,0.6), (-0.6,0.6),(-0.6,0.6)) , n_restarts = 25):
