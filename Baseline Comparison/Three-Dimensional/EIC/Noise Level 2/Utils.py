...
def worst_case_prediction(Point , Model, Scaler):
    ...
    bounds = ((-1.5,1.5),(-1.5,1.5),(-0.1,0.1))
    n_restarts = 2
    n_params = 3
...
def sample_next_point(acquisition_func, Model, robust_optimum, Scaler, bounds = ((-3.5,8.5),(1.5,13.5),(0.1,0.9)) , n_restarts = 25):
...
def find_robust_optimum (Model, Scaler):
    ...
    bounds = ((-3.5,8.5),(1.5,13.5),(0.1,0.9))
    n_params = 3
    n_restarts = 2
