...
def MGFI(candidate, robust_optimum, Model, t,  Scaler, n_params = 3):
...
def sample_next_point(acquisition_func, Model, robust_optimum, temp, Scaler, bounds = ((-4.25,9.25),(0.75,14.25),(0.05,0.95)), 
                      n_restarts = 25):
