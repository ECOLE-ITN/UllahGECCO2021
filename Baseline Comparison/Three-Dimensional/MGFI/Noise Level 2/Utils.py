...
def MGFI(candidate, robust_optimum, Model, t,  Scaler, n_params = 2):
...
def sample_next_point(acquisition_func, Model, robust_optimum, temp, Scaler, bounds = ((-3.5,8.5),(1.5,13.5),(0.1,0.9)), 
                      n_restarts = 25):
